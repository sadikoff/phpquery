 ...
 * @package phpQuery
 * @method PhpQueryObject clone()
 * @method PhpQueryObject empty()
 *
 * @property Int $length
 */
...
//									: null;
                                    ...
                                    if (mb_strpos($attr, '=')) {
                                        ...
                                        if ($attr == 'nodeType') {
                                            ...
                                            if ($this->isRegexp($attr)) {
                                                ...
                                                && phpQuery::$mbstringSupport ? mb_ereg_match(
                                                    $pattern,
    ...
    public function css($property_name, $value = false)
    {
        ...
        if ($specificity >= 1000) {
            ...
            if (empty($styles)) {
                ...
                $parser = new CssParser('{' . join(';', $styles) . '}');
                $doc    = $parser->parse();
     ...
     * Enter description here...
     *
     * @param null|string|phpQueryObject $selector
     *
     * @return phpQueryObject
     */
